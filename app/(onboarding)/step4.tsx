...
export default function Step4() {
  ...
  return (
    ...
    >
      ...
      <Text style={classstyles.headerText}>Your interests</Text>
        ...
        {SPORTS.map((s) => (
          ...
          >
            <Text
              style={[
                styles.chipText,
                sports.includes(s) && styles.chipTextActive,
              ]}
            >
              {s}
            </Text>
        ...
        {INTERESTS.map((i) => (
          ...
          >
            <Text
              style={[
                styles.chipText,
                interests.includes(i) && styles.chipTextActive,
              ]}
            >
              {i}
            </Text>
      ...
      >
        <Text style={styles.buttonText}>
          {sports.length + interests.length > 0 ? "Next →" : "Skip for now"}
        </Text>
      </Pressable>
    </ScrollView>
  );
