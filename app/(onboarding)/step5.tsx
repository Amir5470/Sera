...
export default function Step5() {
  ...
  return (
    ...
    >
      ...
      <Text style={classstyles.headerText}>Almost done!</Text>
      ...
      <View style={styles.chips}>
        {NOTIFICATIONS.map((n) => (
          <Pressable
            ...
            style={[
              styles.chip,
              notifications.includes(n) && styles.chipActive,
            ]}
            onPress={() => toggle(n)}
          >
            <Text
              style={[
                styles.chipText,
                notifications.includes(n) && styles.chipTextActive,
              ]}
            >
              {n}
            </Text>
        ...
        {HEARD_FROM.map((h) => (
          ...
          >
            <Text
              style={[
                styles.chipText,
                heardFrom === h && styles.chipTextActive,
              ]}
            >
              {h}
            </Text>
